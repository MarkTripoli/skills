...
5. Write a short `NN-fix-<slug>.md` receipt with artifact type `fix`, recording the cause, change, and verification. When not run by the workflow engine, commit the receipt as `docs(task): fix artifact`.
