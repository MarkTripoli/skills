...
export function choices(snapshot, goal = '', expected = [], recentActions = []) {
  ...
  const operations = allOperations.filter(op => !((op === 'WAIT' && relevantAmbiguity.length > 0) || (op === 'DONE' && attemptedTextTargets.size > 0 && allOperations.includes('TAP') && !expectedVisible)));
