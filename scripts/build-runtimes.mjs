...
// Usage: node scripts/build-runtimes.mjs --runtime <claude-code|codex|oh-my-pi|pi> [--dest <dir>]
// The layout of the output is described in scripts/lib/build.mjs.

import path from "node:path";
import { RUNTIMES, buildRuntime, repoRoot } from "./lib/build.mjs";
...
try {
  const result = buildRuntime(runtime, dest);
