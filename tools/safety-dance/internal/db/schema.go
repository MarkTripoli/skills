...
CREATE TABLE IF NOT EXISTS runs (
    ...
    safety_dance_version     TEXT,
    safety_dance_build_sha   TEXT,
...
CREATE TABLE IF NOT EXISTS accepted_refs (
    id TEXT PRIMARY KEY,
    repo_id TEXT NOT NULL REFERENCES repos(id) ON DELETE CASCADE,
    branch TEXT NOT NULL,
    gate_head TEXT NOT NULL,
    previous_reconciled_head TEXT,
    launch_nonce TEXT NOT NULL,
    validation_generation TEXT,
    requested_options TEXT,
    accepted_at INTEGER NOT NULL
);
CREATE INDEX IF NOT EXISTS idx_accepted_refs_repo_branch ON accepted_refs(repo_id, branch, accepted_at);
CREATE TABLE IF NOT EXISTS publications (
    run_id TEXT PRIMARY KEY REFERENCES runs(id) ON DELETE CASCADE,
    repo_id TEXT NOT NULL,
    ref TEXT NOT NULL,
    candidate TEXT NOT NULL,
    verified_upstream TEXT NOT NULL,
...
var migrationStatements = []string{
	...
	// <SD_HOME>/worktrees placement at read time - the only one they can have,
	...
	`ALTER TABLE runs ADD COLUMN safety_dance_version TEXT`,
	`ALTER TABLE runs ADD COLUMN safety_dance_build_sha TEXT`,
