...
func TestSweepRunWorktreeStrictBlocksOnSignalFailure(t *testing.T) {
	oldList, oldCWD, oldSignal, oldGroup, oldAlive := listProcessesFunc, processCWDsFunc, signalProcessFunc, signalGroupFunc, processAliveFunc
	t.Cleanup(func() {
		listProcessesFunc, processCWDsFunc, signalProcessFunc, signalGroupFunc, processAliveFunc = oldList, oldCWD, oldSignal, oldGroup, oldAlive
	})
