...
const DefaultBranch = "safety-dance/evidence"

// MarkerPath is the file every safety-dance evidence branch carries at its
...
const MarkerPath = ".safety-dance-evidence"
...
const MarkerContent = `This branch holds test evidence published by safety-dance.
