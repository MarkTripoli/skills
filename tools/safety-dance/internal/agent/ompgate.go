...
//
// safety-dance drives omp only through ACP (acpx), as the dynamic target
...
const ompGateOverlayYAML = `# Written by safety-dance for a gate run under disable_project_settings: true.
