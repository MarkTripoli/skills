...
INSERT INTO runs (run_id, owner_user_id, channel_id, thread_ts, permalink, lifecycle, slack_mode, started_at, finished_at)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,
		r.RunID, r.OwnerUserID, r.ChannelID, r.ThreadTS, r.Permalink, r.Lifecycle, r.SlackMode, r.StartedAt, r.FinishedAt)
	if err != nil {
...
SELECT run_id, owner_user_id, channel_id, thread_ts, permalink, lifecycle, slack_mode, started_at, finished_at
